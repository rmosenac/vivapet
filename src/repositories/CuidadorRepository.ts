...
export class CuidadorRepository {
    ...
    public async salvar(cuidador: Cuidador) {
        ...
        const values = [cuidador.id, cuidador.nome, cuidador.cpf, cuidador.email, cuidador.data_cadastro, cuidador.ativo];
    ...
    public async atualizar(cuidador: Cuidador) {
        ...
        const values = [cuidador.id, cuidador.nome, cuidador.cpf, cuidador.email, cuidador.ativo];
