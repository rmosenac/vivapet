export class Suprimento {
  ...
  constructor(
    id: string, nome: string, unidade: string, quantidadeEstoque: number,
    quantidadeMinima: number, dataCadastro: Date = new Date(), ativo: boolean = true
  ) {
    this._id = id;
    this._nome = nome;
  ...
  public get unidade() { return this._unidade; }
  public set unidade(unidade: string) { this._unidade = unidade; }

  public get quantidadeEstoque() { return this._quantidadeEstoque; }
  public set quantidadeEstoque(quantidadeEstoque: number) { 
    this._quantidadeEstoque = Math.floor(quantidadeEstoque); 
  }

  public get quantidadeMinima() { return this._quantidadeMinima; }
  public set quantidadeMinima(quantidadeMinima: number) { 
    this._quantidadeMinima = Math.floor(quantidadeMinima); 
  }

  public get dataCadastro() { return this._dataCadastro; }
  public set dataCadastro(dataCadastro: Date) { this._dataCadastro = dataCadastro; }
