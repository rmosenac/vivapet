...
export class Cuidador {
  ...
  constructor(
    ...
    dataCadastro: Date = new Date(), ativo: boolean = true
  ) {
    this._id = id;
    this._nome = nome;
    this._cpf = cpf;
  ...
  public get animaisSobResponsabilidade() { return this._animaisSobResponsabilidade; }
  public set animaisSobResponsabilidade(animais: Animal[]) { this._animaisSobResponsabilidade = animais; }
